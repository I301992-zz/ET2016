...
<body>
<form:form name="form1" method="POST"  action="/StudentMgmt/afterAdd/${college}" >
FirstName<form:input path="firstname" type="text"  /><br><br>
Lastname<form:input path="lastname" type="text"/><br><br>
urn<form:input path="urn" type="text"/><br><br>
...
College<form:input path="college" type="text" value="${college}"/>
